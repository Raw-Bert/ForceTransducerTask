...
public class CSVRead : MonoBehaviour
{
    ...
    private string getPath(){
        ...
        //return Application.dataPath + "/.." + "/CSV/Input/Block_1.csv";
        return Path.Combine(Application.streamingAssetsPath, "CSV/Input/Block_1.csv");
    }
    private string getPath2(){
         
        //return Application.dataPath +"/CSV/Input/"+"Block_2.csv"; //filepath
        //return Application.dataPath + "/.." + "/CSV/Input/Block_2.csv";
        return Path.Combine(Application.streamingAssetsPath, "CSV/Input/Block_2.csv");
    }

    private string getPath3(){
         
        //return Application.dataPath +"/CSV/Input/"+"Block_3.csv"; //filepath
        //return Application.dataPath + "/.." + "/CSV/Input/Block_3.csv";
        return Path.Combine(Application.streamingAssetsPath, "CSV/Input/Block_3.csv");
    }

    private string getPath4(){
         
        //return Application.dataPath +"/CSV/Input/"+"Block_4.csv"; //filepath
        //return Application.dataPath + "/.." + "/CSV/Input/Block_4.csv";
        return Path.Combine(Application.streamingAssetsPath, "CSV/Input/Block_4.csv");
    }

    //read in the CSV files based on file paths
    public void ReadCSVFiles(int blocks){
        Debug.Log("Starting file reading!");
        ...
        Debug.Log("End file reading");
        Debug.Log("Blocks: " + blocks);


        //DrawLines();
        randomTracker = new List<int>(new int[blocks]);
        int rand;
        for (int a = 0; a < (blocks / 4); a++)
        {
            for (int b = 0; b < 4; b++)
            {
